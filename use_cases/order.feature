 Feature: Order
  ...
  Scenario Outline: Customer Create Order
    Given customer create order
    When customer add   products list with <category> <name> <description> and <address>
    Then order status should be waiting
    And order product details should be as <result_category> <result_name> <result_description> and <result_address>
