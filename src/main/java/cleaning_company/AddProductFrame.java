...
Customer customer = null;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Your Product");

        jLabel2.setText("product name");

        jLabel3.setText("Description (e.g wight, size,...)");
        ...
        jLabel4.setText("special treatment");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	product.description = jTextArea1.getText();
    	product.specialTraetment = jTextArea2.getText();
    	product.owner = customer;
    	//product.owner =  customer.getCustomer(); 
    	
       JOptionPane.showMessageDialog(null, product);
       InvoiceJFrame invoiceFrame = new InvoiceJFrame();
       invoiceFrame.product = product;
       invoiceFrame.show();
